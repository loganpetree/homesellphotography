    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {packages.map((pkg) => (
            <div key={pkg.name} className="rounded-2xl border border-gray-100 p-6 shadow-sm">
        ...
        <CtaBand title="See live pricing for your listing" subtitle="Enter the property in booking to get the right package without back-and-forth." />
      </main>
      <SiteFooter />
    </div>
  );
