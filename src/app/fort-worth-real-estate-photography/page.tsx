...
export const metadata: Metadata = {
  title: "Fort Worth Real Estate Photography",
  description: "Fort Worth real estate photography for Tarrant County listings — professional stills, drone, and floor plans from Homesell Photography.",
  alternates: { canonical: "/fort-worth-real-estate-photography" },
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
          Fort Worth Real Estate <span className="text-[#22C55E]">Photography</span>
        </h1>
        <p className="text-lg text-gray-600 max-w-3xl mb-6">
          Fort Worth real estate photography for Tarrant County listings — professional stills, drone, and floor plans from Homesell Photography.
        </p>
        <div className="mb-10">
          <BookLink
            location="city_fort_worth_hero"
          ...
          >
            Book Fort Worth photography
          </BookLink>
        </div>
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="rounded-2xl border border-gray-100 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-3">Why agents book us in Fort Worth</h2>
        ...
        <div className="prose prose-gray max-w-3xl mb-8">
          <p className="text-gray-600">Fort Worth has its own market rhythm — from near-south and cultural-district properties to west-side and suburban homes. We shoot for how local buyers browse, with consistent quality and communication from schedule to delivery.</p>
        ...
        <CtaBand title="Book Fort Worth listing photography" location="city_fort_worth_cta" />
      </main>
      <SiteFooter />
    </div>
  );
