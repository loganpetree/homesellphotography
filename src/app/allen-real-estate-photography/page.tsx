...
export const metadata: Metadata = {
  title: "Allen Real Estate Photography",
  description: "Allen real estate photography for family homes and Collin County listings. Professional photos, drone, and floor plans with Homesell Photography.",
  alternates: { canonical: "/allen-real-estate-photography" },
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
          Allen Real Estate <span className="text-[#22C55E]">Photography</span>
        </h1>
        <p className="text-lg text-gray-600 max-w-3xl mb-6">
          Allen real estate photography for family homes and Collin County listings. Professional photos, drone, and floor plans with Homesell Photography.
        </p>
        <div className="mb-10">
          <BookLink
            location="city_allen_hero"
          ...
          >
            Book Allen photography
          </BookLink>
        </div>
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="rounded-2xl border border-gray-100 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-3">Why agents book us in Allen</h2>
        ...
        <div className="prose prose-gray max-w-3xl mb-8">
          <p className="text-gray-600">Allen is a competitive suburban market where presentation matters. Bright, accurate listing photos — plus optional floor plans for open layouts — help your listing stand out among similar floor plans and price points across Allen and neighboring Plano and McKinney.</p>
        ...
        <CtaBand title="Book Allen listing photography" location="city_allen_cta" />
      </main>
      <SiteFooter />
    </div>
  );
